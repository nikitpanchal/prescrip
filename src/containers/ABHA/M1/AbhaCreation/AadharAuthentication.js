...
class AadharAuthentication extends Component {
    ...
    verify() {
        if (!this.state.otpValue && !this.state.txnId && !this.state.mobile) {
                                ...
                                {!this.state.restart && this.state.hideTimer && this.state.attempt <= 2 ?
                                    <View style={{
                                        ...
                                        <CountDown
                                            ...
                                            until={10} timeToShow={['M', 'S']}
                                            timeLabels={{ m: null, s: null }}
                                            timeLabelStyle={{}}
                                            showSeparator
                                            sRemaining={2000 * 30} onFinish={() => this.timerFinished()} allowFontScaling={true} />
                                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(AadharAuthentication);
