    ...
    render() {
        ...
        return (
            <View style={{ flex: 1  }}>
                ...
                <ImageBackground style={{
                    ...
                    <SafeAreaView>
                        <TouchableOpacity style={{ padding: 8, marginTop: 10 }}>
                            <Image source={PrescripLogo} style={{
                                alignSelf: 'center',
                                marginTop: Platform.OS == 'ios' ? null : 35, resizeMode: 'contain', height: 27,
                            }} />
                        </TouchableOpacity>
                        <ScrollView>
                ...
                <View style={{
                    flex: 0.2, flexDirection: 'column', alignItems: 'center',
                    justifyContent: 'center', width: Dimensions.get('window').width,  backgroundColor: '#fff' 
                }}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Register')}>
                        <LinearGradient colors={["#29b62f", "#06d611"]} start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 1 }} locations={[0, 0.8]} style={{
                                width: Dimensions.get('window').width - (Dimensions.get('window').width * 50 / 100),
