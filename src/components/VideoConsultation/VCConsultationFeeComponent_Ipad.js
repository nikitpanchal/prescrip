...
class VCConsultationFeeComponent_Ipad extends Component {
    constructor(props) {
        super(props);
                    ...
                    <ImageBackground style={[styles.container]} source={BG}>
                        ...
                        <SafeAreaView style={{ flex: 1 }}>
                            <View style={{ flex: 0.3 }}>
                                ...
                                {Platform.isPad ? <View style={[styles.consult_text_view3, { flex: 1, marginTop: 10 }]}>
                            ...
                            <TouchableOpacity style={{ flex: 0.1, backgroundColor: '#fff', justifyContent: 'flex-end' }} disabled={this.state.consult_text > 27.5 || this.state.consult_text == 0 ? false : true} onPress={() => this.props.navigation.navigate('DigiConsultationSetupContainer')}>
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(VCConsultationFeeComponent_Ipad);